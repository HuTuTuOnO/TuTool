...
function updateScript(){
    wget -N https://raw.githubusercontent.com/HuTuTuOnO/TuTool/main/tutool.sh && chmod +x tutool.sh && ./tutool.sh
}
# ==============part9=============
...
function aliasInstall() {
	...
	if [[ -f "$HOME/tutool.sh" ]] && [[ -d "/etc/tutool" ]] && grep <"$HOME/tutool.sh" -q "作者:TuTool"; then
